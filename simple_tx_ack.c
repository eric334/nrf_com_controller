...
//#if defined(TEST_SIMPLE_TX_ACK)

extern void test_run_info(unsigned char *data);

/* Example application name */
#define APP_NAME "SIMPLE TX ACK v1.0"
...
//static uint8_t tx_msg[] = {3, 2, 10, 'H', 'E', 'L', 'L', 'O', 'W', 'O', 'R', 'L', 'D'};
 ...
 */
int simple_tx_ack(unsigned int * tx_msg, int size)
{
    int FRAME_LENGTH = size + FCS_LEN;
